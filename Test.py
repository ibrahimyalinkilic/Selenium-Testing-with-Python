...
class Test(unittest.TestCase):
    ...
    def test_succesful_login(self):
        ...
        self.driver.find_element_by_id("userName").send_keys("true-email")
        self.driver.find_element_by_id("password").send_keys("truePassword")
    ...
    def test_wrong_mail_login(self):
        self.driver.find_element_by_xpath("//*[@id='root']/div/div[1]/div[1]/div/div/div[2]/a[1]").click()
        self.driver.find_element_by_id("userName").send_keys("wrong-email")
        self.driver.find_element_by_id("password").send_keys("truePassword")
        self.driver.find_element_by_xpath("//*[@id='root']/div/div[3]/button/span[1]").click()
        time.sleep(1)
        x = self.driver.find_element(By.XPATH, "//*[@id='root']/div/div[3]/div[4]/div").text
    ...
    def test_invalid_login(self):
        self.driver.find_element_by_xpath("//*[@id='root']/div/div[1]/div[1]/div/div/div[2]/a[1]").click()
        self.driver.find_element_by_id("userName").send_keys("invalid mail")
